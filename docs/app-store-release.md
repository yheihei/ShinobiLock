...
2026年9月14日22:21、1.0.0（ビルド12）をApp Reviewへ提出し、「審査待ち」を確認しました。初回は日本のみ・無料、承認後に自動公開する設定です。公開はまだ完了していません。

## 登録済みのサービス

| 項目 | 値・状態 |
| --- | --- |
| App Store Connect | Apple ID `6811883726`、1.0.0（12）を提出済み。「審査待ち」 |
...
1. App Reviewの結果を確認し、指摘があれば対応する。自動公開の設定により、承認後は日本のApp Storeへ公開される。
